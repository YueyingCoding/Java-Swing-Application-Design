...
//    @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        add(btnconfirm);
        btnconfirm.setBounds(570, 580, 120, 29);
        ...
        add(btnback);
        btnback.setBounds(640, 20, 120, 29);
...
//        ct.setEmailAdd(EmailAdd);
        ...
        // Validation!!!!
        if(Username.equals("")|| PhoneNum.equals("") ||Password.equals("") ||Address.equals("") ||Gender.equals("") ||EmailAdd.equals(""))
            JOptionPane.showConfirmDialog(null, "Every Filed is Required!");
        else
        {
            String Query; 
            Query="insert into person(username,zipcode,phone number,password,address,gender,email)values(?,?,?,?,?,?,?)";
