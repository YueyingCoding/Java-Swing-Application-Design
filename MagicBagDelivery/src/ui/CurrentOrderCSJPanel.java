...
//        populateFinishedTable();
    ...
    public void Table(){
       ...
       ResultSet rs=Select.getData("select * from CustomerService where status!='Completed' ");
    ...
    private void initComponents() {
        ...
        jTextField4.setBounds(590, 160, 115, 30);
    ...
    private void btnback1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnback1ActionPerformed
        ...
        if (SelectedRowIndex1 > 0){
            ...
            DefaultTableModel model = (DefaultTableModel) jTable4.getModel();
            int ordernumber=(int)model.getValueAt(SelectedRowIndex1,0);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
             String Query;
             Query="insert into CustomerService(decision) values('"+decision+"') where ordernumber='"+ordernum+"' ";
